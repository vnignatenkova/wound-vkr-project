...
LAST_MODEL_PATH = RESULTS_DIR / "deeplab_last_model.pth"
...
def build_model():
    try:
        ...
        print("Используется DeepLabV3-ResNet50 с pretrained backbone.")
    except Exception as e:
        print(f"[WARN] Не удалось загрузить pretrained backbone: {e}")
        print("Запускаю DeepLabV3-ResNet50 без pretrained backbone.")
        model = deeplabv3_resnet50(
            weights=None,
